...
def run():
    ...
    df.to_csv("../data/nlp_scored.csv", index=False)
    print("Saved -> ../data/nlp_scored.csv")
    ...
    print("Saved -> ../data/anomalies.csv")
    ...
    df_scaled.to_csv("../data/processed.csv", index=False)
    ...
    df_scaled.to_csv("../data/clustered.csv", index=False)
    ...
    print("="*60)
    df = full_risk_pipeline(df, train_weights=False)
